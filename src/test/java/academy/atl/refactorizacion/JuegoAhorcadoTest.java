...
public class JuegoAhorcadoTest {
    ...
    //Objeto de Pruebas,No es verdadero
    @Mock
    ...
    public void probarPagosConPaypal() {
        /**
         * Este es un comportamiento que queremos que tenga cuando se ejecute
         *     @Mock
         *     private PaypalConnection paypalConnection;
         * doNothing(), No hagas nada -> .when() cuándo -> .pagar(any()); se realiza
         * un pago de cualquier monto
         */
